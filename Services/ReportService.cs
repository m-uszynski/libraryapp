...
namespace Services
{
    public class ReportService
    {
        ...
        public IEnumerable<ReportBooksViewModel> GetPageableMostOftenBorrowedBooksWithFilter(int skip, int take, int pageSize, string title, DateTime? fromdate, DateTime? todate, out int totalCount)
        {
